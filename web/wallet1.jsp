...
<html>
    ...
    <body onload="submitPayuForm();">
        ...
        <div class="topnav" id="myTopnav">             <% try{
            ...
            <div class="left">
                <form action="<%= action1%>" method="post" name="payuForm">
                    ...
                    <table>
                        ...
                        <tr>
                         TxnId :<input name="txnid" value="<%= (empty(params.get("txnid"))) ? "" : params.get("txnid")%>" />
                        </tr>
                        <tr>
                            <td colspan="2" hidden>Success URI: </td>
                            <td colspan="2" hidden><input name="surl" value="http://localhost:8080/Register/wallet2.jsp" size="64" hidden/></td>
                        </tr>
                        <tr>
                            <td colspan="2" hidden>Failure URI: </td>
                            <td colspan="2" hidden><input name="furl" value="http://localhost:8080/Register/wallet1.jsp" size="64" hidden/></td>
                        </tr>

                        <tr>
                            <% if (empty(hash)) { %>
                            <td colspan="4"><input type="submit" class="b1" value="Add Money to Wallet" /></td>
                                <% }%>
                        </tr>
                    </table>
                </form>
            ...
            <div class="right">
                <%
                    try {
                        ...
                        ResultSet rs = stmt.executeQuery("select amount from wallet where email='" + email1 + "' ");
...
//                                            out.println("Sorry, could not find your profile at the moment. ");
                                            ...
                                            out.println("<tr><td>" + rs.getString("amount") + "</td></tr>");
                                        }
                                    } catch (Exception e) {
                ...
                <form action="wallet.jsp" method="post">
                    <table>
                        ...
                        <tr>                
                            <td><input type="number" name="amount" placeholder="Enter the Amount to be Paid" value="" /></td>
                        </tr>   
                        <tr>
                        TxnId :<input name="txnid" value="<%= (empty(params.get("txnid"))) ? "" : params.get("txnid")%>" />
                        </tr>
                        <tr>
                            <% if (empty(hash)) { %>
                            <td colspan="4"><input type="submit" class="b1" value="Pay Money through Wallet" /></td>
                                <% }%>
                        </tr>
                    </table>
                </form>
